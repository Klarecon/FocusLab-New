...
export interface VideoTextProps {
  ...
  children: ReactNode;
  /** Font size for the text mask (in viewport width units) @default 10 */
  fontSize?: string | number;
  /** Font weight for the text mask @default "bold" */
  fontWeight?: string | number;
  /** Text anchor for the text mask @default "middle" */
  textAnchor?: string;
  /** Dominant baseline for the text mask @default "middle" */
  dominantBaseline?: string;
  /** Font family for the text mask @default "Fraunces, serif" */
  fontFamily?: string;
  /** The element type to render for the text @default "div" */
  as?: ElementType;
}
